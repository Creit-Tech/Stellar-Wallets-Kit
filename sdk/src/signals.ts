/**
 * This code comes from https://github.com/preactjs/signals/blob/main/packages/core/src/index.ts
 * We copy it here so we don't need to have a separated dependency
 */
